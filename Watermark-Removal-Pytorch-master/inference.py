...
parser.add_argument('--image-path', type = str, default = './data/watermark-unavailable/watermarked/21.jpg', help = 'Path to the "watermarked" image.')
parser.add_argument('--mask-path', type = str, default = './data/watermark-unavailable/masks/222.jpg', help = 'Path to the "watermark" image.')
...
parser.add_argument('--training-steps', type = int, default = 300, help = 'Number of training iterations.')
